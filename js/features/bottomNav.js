/* ============================================================
   ...
   ============================================================
   Converted from apple-liquid-glass-switcher.tsx to pure JS
   - SVG displacement map filters for liquid distortion
   - Fluid sliding animation with stretch
   - scaleToggle animations from the React component
   ============================================================ */
...
/* ===== SVG FILTERS — from apple-liquid-glass-switcher.tsx =====
   These displacement maps create the liquid glass distortion effect.
   The base64 image data is the noise map used by feDisplacementMap.
*/
...
export function initBottomNav() {
  ...
  // Inject SVG displacement filters (from apple-liquid-glass-switcher)
  const filterWrap = createEl('div', { className: 'bottom-nav-filters' });
  filterWrap.innerHTML = SVG_FILTERS_HTML;
